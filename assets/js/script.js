...
function weatherFetch(cityName) {
    ...
    fetch(requestUrl)
        ...
        .then(function (coords) {
            ...
            var requestUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=6d8c8c2517262ec75ca50bfee4f15b76`
            var requestUrl2 = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=6d8c8c2517262ec75ca50bfee4f15b76`
